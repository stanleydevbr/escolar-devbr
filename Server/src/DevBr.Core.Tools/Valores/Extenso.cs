namespace DevBr.Core.Tools.Valores
{
    public static class Extenso
    {
        public static string ToExtenso(this decimal valor)
        {
            ...
            else
            {
                ...
                {
                    valor_por_extenso += AuxiliarExtenso(Convert.ToDecimal(strValor.Substring(i, 3)));
        ...
        static string AuxiliarExtenso(decimal valor)
        {
            if (valor <= 0)
                return string.Empty;
            else
